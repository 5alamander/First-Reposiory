...
(function() {
  ...
  Buff = (function() {
    ...
    Buff.prototype.decorate2 = function(key, func) {
      if (Buff.prototype[key] != null) {
        throw new Error('the key has already exist');
      }
      return Buff.prototype[key] = function() {
        var args;
        args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return console.log(key + ' ' + __slice.call(args));
      };
    };
  ...
  t.decorate2('delete', function() {});

  s.decorate2('dle', function() {});
